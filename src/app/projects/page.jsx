        ...
        <div className="flex justify-between items-end mb-8">
          ...
          {user?.role === 'ADMIN' && !isCreating && (
            <button 
              ...
              className="flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-slate-800 shadow-sm transition-all hover:-translate-y-0.5 cursor-pointer"
            >
          ...
          >
            ...
            <div className="flex gap-2 shrink-0">
              <button 
                ...
                className="text-sm text-slate-500 hover:text-slate-800 font-semibold px-3 py-2 transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button 
                type="submit" 
                className="bg-indigo-600 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-700 shadow-sm transition-all cursor-pointer"
              >
                Create Project
              </button>
            </div>
